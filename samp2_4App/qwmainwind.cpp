...
//工具栏
    ...
    QMenu *menuInfo = ui->menuBar->addMenu(tr("信息")); //在菜单栏添加"信息"菜单
    actAbout = new QAction(tr("关于本程序"), this);     //创建"关于"动作
    actAbout->setObjectName(QStringLiteral("actAbout"));//设置对象名
...
void QWMainWind::on_actAbout_triggered()
{
    ...
    QString aboutContent = tr("姓名：喻兴洪\n")
                           + tr("学号：2023414290435\n");


    // 显示标准About对话框（标题+内容，父窗口为当前窗口）
    QMessageBox::about(this, tr("关于本程序"), aboutContent);
}
