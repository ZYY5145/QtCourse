...
public:
    ...
    void retranslateUi(QMainWindow *QWMainWind)
    {
        ...
        actAbout->setText(QCoreApplication::translate("QWMainWind", "\344\277\241\346\201\257", nullptr));
#if QT_CONFIG(shortcut)
        actAbout->setShortcut(QCoreApplication::translate("QWMainWind", "Ctrl+N", nullptr));
#endif // QT_CONFIG(shortcut)
